...
module.exports = function($scope,$q,diskTypeSrv,$timeout) {
  $scope.periods = [
    {
      period:60,text:"1分钟"
    },
  ...
  function listDisks(baseOptions){
    ...
    diskTypeSrv.listDisks().then(function(result){
      var HDD_disks = [];
      var SSD_disks = [];
      ...
      for(var i=0;i<result.entities.length;i++){
        ...
        if(result.entities[i].storageTierName=="HDD"){
          ...
          HDD_disks.push(diskTypeSrv.GetMetricStatistics(
            {
              "version":"2010-08-01",
              "namespace":"vega",
          ...
          SSD_disks.push(diskTypeSrv.GetMetricStatistics(
            {
              "version":"2010-08-01",
              "namespace":"vega",
              "statistics":tempOptions.statistics,
